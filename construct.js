define(["heya-has/sniff", "./window", "./main", "./prop"],
		function(has, win, dom, prop){
	// module:
	//		dojo/dom-construct
	// summary:
	...
	var create, destroy, module = {
		...
		create: create = function create(/*DOMNode|String*/ tag, /*Object*/ props, /*DOMNode|String?*/ refNode, /*String?*/ pos){
			// summary:
		...
		empty: function empty(/*DOMNode|String*/ node){
			 // summary:
		...
		destroy: destroy = function destroy(/*DOMNode|String*/ node){
			// summary:
